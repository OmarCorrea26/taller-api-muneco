# etapas/etapa_6_publicar/app.py
# Etapa 6 — publicar
#
# Responsable: [tu nombre]
# Ejecutar desde la raiz del repo:
#   uvicorn etapas.etapa_6_publicar.app:app --port 8006 --reload
#
# Reglas del contrato para esta etapa: contrato/esquemas.py (Entrada6 / Salida6)
# y contrato/validaciones.py (validar_etapa_6).
